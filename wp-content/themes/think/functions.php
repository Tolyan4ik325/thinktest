...
function think_scripts() {
	wp_enqueue_style( 'think-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'think-style', 'rtl', 'replace' );

	wp_enqueue_script( 'think-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
